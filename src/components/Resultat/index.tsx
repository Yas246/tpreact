            ...
            <div className="grid flex-1 grid-cols-2 justify-center gap-8 md:grid-cols-1">
              <div className="flex w-full flex-col gap-4 border border-solid border-gray-300 bg-white-A700 p-6 sm:p-5">
                ...
                <div className="flex gap-4">
                  <Button className="h-[34px] w-[98px] rounded-[17px] bg-teal-300_19 px-[9px] text-sm font-semibold text-teal-300">
                    {business}
                  </Button>
                  <Button color="indigo_A700" shape="round" className="min-w-[145px] font-semibold">
                    {paymentGateway}
                  </Button>
                </div>
              </div>
