...
export default function Filter({
  ...
  return (
    <div {...props}>
      <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-[1095px] w-full items-center justify-center bg-[url(/public/images/img_landing_page_latest.svg)] bg-cover bg-no-repeat py-[72px] md:h-auto md:py-5">
